...
5. `.github/instructions/blog-authoring.instructions.md` — required when creating or editing blog posts
...
- `.github-copilot/.github/instructions/platform.hosting.instructions.md`
- `.github-copilot/.github/instructions/platform.monitoring.instructions.md`
- `.github-copilot/.github/instructions/platform.instructions.md`

### Shared library / automation contracts (only those this repo consumes)
- `.github-copilot/.github/instructions/shared.actions.instructions.md`
...
# Single test
dotnet test src/MX.CraftPledge.sln --filter "FullyQualifiedName~MyTestClass.MyTestMethod"
...
- ❌ Do not introduce a database, authentication flow, or dynamic backend persistence unless that is the explicit task — this repo is currently a brochure site.
- ❌ Do not add or edit blog content without following `.github/instructions/blog-authoring.instructions.md`.
...
- [ ] `dotnet build src/MX.CraftPledge.sln` passes
- [ ] `dotnet test src/MX.CraftPledge.sln` passes
- [ ] `dotnet format src/MX.CraftPledge.sln --verify-no-changes` passes
...
- The change would shift the repo from brochure-site behavior into authenticated, data-backed application behavior without explicit approval.